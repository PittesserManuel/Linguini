...
export const modulKlassenzimmer: Modul = {
  ...
  wortschatz: [
    // --- Lernwoerter: Schreiben und Radieren ---
    {
      ...
      bildQuelle: 'objekte/bleistift.png',
      neu: true,
      punkt: { x: 36, y: 75 },
      labelSeite: 'unten',
    },
    {
      ...
      bildQuelle: 'objekte/buntstift.png',
      neu: true,
      punkt: { x: 68, y: 75 },
      labelSeite: 'unten',
    },
    ...
    },
    {
      ...
      bildQuelle: 'objekte/spitzer.png',
      neu: true,
      punkt: { x: 82, y: 59 },
      labelSeite: 'oben',
    },
    ...
    },
    {
      ...
      bildQuelle: 'objekte/geodreieck.png',
      neu: true,
      punkt: { x: 39, y: 59 },
      labelSeite: 'oben',
    },
    ...
    },
    {
      ...
      bildQuelle: 'objekte/pflanze.png',
      neu: true,
      punkt: { x: 6, y: 27 },
      labelSeite: 'rechts',
    },
    {
      ...
      bildQuelle: 'objekte/papierkorb.png',
      neu: true,
      punkt: { x: 94, y: 88 },
      labelSeite: 'links',
    },
  ...
  //
  // Beides kommt aus den vier Jahrgangsfassungen (siehe
  // klassenzimmer-jahrgaenge.ts). `lesetext` und `aufgaben` zeigen auf die
  // mittlere Fassung: Sie sind die Voreinstellung fuer alles, was keine
  // Jahrgangswahl kennt, und halten aeltere Aufrufer lauffaehig.
  // -------------------------------------------------------------------------
  lesetext: textMs2.lesetext,
  aufgaben: textMs2.aufgaben,
  jahrgangstexte: klassenzimmerJahrgaenge,
